...
def test_statistic(X, ns, nt, n_clusters, Sigma, labels_all_obs, members_all_obs):
...
def test_statistic_multidim(X, n_clusters, Sigma, labels_all_obs, members_all_obs):
    n,d=X.shape
...
if __name__ == "__main__":
    ...
    plt.savefig('logs/selective_inference_log/p_values_histogram2.png')
    with open('logs/selective_inference_log/p_values2.txt', 'a') as f:
